...
export const reportsApi = {
  ...
  today: () => apiClient.get('/reports/today').then((res) => res.data),
  classWise: (params) => apiClient.get(withQuery('/reports/class-wise', params)),
  studentSearch: (params) => apiClient.get(withQuery('/reports/student-search', params)),
