...
export function CohortDetailPage() {
  ...
  return (
    <div>
      {view === 'modules' && (
        <>
          <PageHeader
            ...
            title={cohort.name}
            subtitle={`${cohort.learner_count} students${cohort.advisor_first_name ? ` · ${cohort.advisor_first_name} ${cohort.advisor_last_name}` : ''}`}
          />
      ...
      {view === 'teachers' && (
        <>
          <div className="mb-4 flex items-center gap-1.5 text-[12.5px] font-semibold text-ink-500">
            <BackButton onClick={() => setView('modules')} />
