...
const instructorModulesRoutes = require('./modules/instructorModules/routes');
const instructorCohortsRoutes = require('./modules/instructorCohorts/routes');
...
app.use('/api/v1/instructor-modules', instructorModulesRoutes);
app.use('/api/v1/instructor-cohorts', instructorCohortsRoutes);
