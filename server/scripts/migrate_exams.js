...
const sqlQuery = `
SET search_path TO "tenant_qschool_onecampus_local";
...
SET search_path TO "tenant_dev_onecampus_local";
CREATE TABLE IF NOT EXISTS onec_online_exams (
    id SERIAL PRIMARY KEY,
    title VARCHAR(255) NOT NULL,
    description TEXT,
...
SET search_path TO "tenant_dev2_onecampus_local";
CREATE TABLE IF NOT EXISTS onec_online_exams (
    id SERIAL PRIMARY KEY,
    title VARCHAR(255) NOT NULL,
    description TEXT,
...
SET search_path TO "tenant_dev3_kg_onecampus_local";
CREATE TABLE IF NOT EXISTS onec_online_exams (
    id SERIAL PRIMARY KEY,
    title VARCHAR(255) NOT NULL,
    description TEXT,
